...
export default function App() {
  ...
  return (
    // Responsive shell: mobile stays compact, laptop gets a wider, more usable canvas.
    <div className="min-h-screen bg-stone-50 font-sans text-stone-800 w-full mx-auto shadow-2xl overflow-hidden relative border-x border-stone-100 flex flex-col max-w-md md:max-w-2xl lg:max-w-5xl">
      {/* App Header */}
